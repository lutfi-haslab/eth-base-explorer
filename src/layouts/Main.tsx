...
function ActiveLink({ children, href }: Links) {
  ...
  return (
    <Link
      href={href}
      className={`active:bg-gray-100 flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-900 dark:text-white ${
        active ? "bg-gray-100" : ""
      }`}
    >
      {children}
...
const Main = ({ children }: Props) => {
  return (
    <div className="bg-gray-50 dark:bg-slate-900">
      ...
      {/* <!-- Content --> */}
      <div className="h-screen pb-10 w-full px-4 sm:px-6 md:px-8 lg:pl-72">
